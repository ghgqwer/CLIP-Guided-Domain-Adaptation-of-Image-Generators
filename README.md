...
Оригинальная статья: [StyleGAN-NADA: CLIP-Guided Domain Adaptation of Image Generators](https://stylegan-nada.github.io)
...
### ** Adaptive Layer Freezing** (не реализовано) 
